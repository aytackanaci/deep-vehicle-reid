...
def main():
    ...
    criterion['orient'] = CrossEntropyLoss(num_classes=dm.num_train_orients, use_gpu=use_gpu, label_smooth=args.label_smooth, weighting=1, use_batch_subset=True)
    ...
    if args.regress_landmarks:
        ...
        criterion['landmarks'] = CrossEntropyLoss(num_classes=dm.num_train_landmarks, use_gpu=use_gpu, label_smooth=args.label_smooth, multiclass=True, multilabel=True, weighting=1, use_batch_subset=True)
